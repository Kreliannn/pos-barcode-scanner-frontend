...
import { Calendar, Home, Building, Search, UserPlus2, User, FileText, BarChart3, Building2, LogOut, Menu, X, MenuIcon, Receipt, Recycle, Activity, ScanLineIcon } from "lucide-react"
...
export function SideBarCashier({ className }: AppSidebarProps) {
